...
@TestInstance(TestInstance.Lifecycle.PER_CLASS) // objetos instanciados vão durar apenas para essa classe
...
class PersonServiceTest {
    ...
    void setUp() {
        ...
        /*
            Foi retirado para evitar conflitos com o @ExtendWith(MockitoExtension.class)
         */
//        MockitoAnnotations.openMocks(this);
    ...
    void findAll() {
        ...
        List<PersonDTO> people = new ArrayList<>();//0service.findAll();
